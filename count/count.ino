...
************
/// เรื่องที่พี่ถามเรื่องส่วนตัว มันทำให้พี่รู้สึกไม่สบายใจที่ไปยุ่งเรื่องส่วนตัวของน้อง 
/// และน้องก็คงไม่ชอบให้ใครมายุ่งเรื่องส่วนตัวมากๆ พี่ไม่รู้จะขอโทษยังไงจริงๆเอาเป็นว่า 
/// พี่ขอโทษอีกครั้งนะครับน้องจะไม่ให้อภัยก็ไม่เป็นไร ต่อไปนี้พี่คงไม่กล้าคุยหรือถามอีกแล้วครับ ขอบคุณที่ไม่ด่าพี่นะครับพี่นี่มันซื่อบื่อจริงๆเลย by พี่มัช :)
// ปล.ลบก่อนเอาไปส่งด้วยนะ ซู้วๆ :)
